...
export function createTransactionCore(db: DoSqliteCompat) {

  type TransactionCostStatus =
    | "FOUND"
    | "HPP_ZERO"
    | "HPP_MISSING"
    | "SKU_MISSING"
  ...
  function ensureTransactionCoreSchema() {
    db.exec(`
      /*
  ...
  function upsertTransactionLine(
  ...
  function upsertTransactionLines(
  ...
  function getTransactionCoreStats() {
    ensureTransactionCoreSchema();
    return db.prepare(`
      SELECT
