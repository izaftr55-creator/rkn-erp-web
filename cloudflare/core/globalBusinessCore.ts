...
export function createGlobalBusinessCore(db: DoSqliteCompat) {
  ...
  function buildBusinessLineAliasKey(
    input: {
      businessUnitId: unknown;
      platform: unknown;
      storeId: unknown;
  ...
  function buildBusinessEventKey(
    input: {
  ...
  function ensureGlobalBusinessCoreSchema() {
  ...
  type CanonicalOrderLineObservationV11 = {
    aliasType: SourceAliasType;
    aliasValue: string;
  ...
  type CanonicalOrderObservationV11 = {
    source: string;
    sourceRef: string;
  ...
  type CanonicalOrderLineIngestResultV11 = {
  ...
  type CanonicalOrderIngestResultV11 = {
    orderKey: string;
  ...
  function resolveActiveStoreBusinessScopeV11(
  ...
  function ingestCanonicalOrderObservationV11(
    input:
