...
if(view==='CLOSING'){
  ...
  const current = currentClose ? {
    ...currentClose,
    sales_rp: currentClose.status === 'CLOSED' ? currentClose.sales_rp : liveSales,
    cogs_rp: currentClose.status === 'CLOSED' ? currentClose.cogs_rp : liveCogs,
    gross_profit_rp: currentClose.status === 'CLOSED' ? currentClose.gross_profit_rp : (liveSales - liveCogs),
