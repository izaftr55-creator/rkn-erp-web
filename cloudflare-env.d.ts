/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e98cb7b6642cb25d62686a7b05124ce8)
...
interface __BaseEnv_CloudflareEnv {
	...
	RKN_ERP_CORE: DurableObjectNamespace<import("./cloudflare/custom-worker").RknErpCore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/custom-worker");
		durableNamespaces: "RknErpCore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_SHEET_ID" | "GOOGLE_SERVICE_ACCOUNT_EMAIL" | "GOOGLE_PRIVATE_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
