...
/* ============================================================
 * RKN_INVENTORY_CORE_V10_0_START
 *
 * Physical inventory is intentionally separated from:
 *
 * - marketplace stock snapshots
 * - SKU mapping status
 * - transaction_ledger / costing
 *
 * Inventory mutation is ledger-backed and idempotent.
 * ============================================================ */
...
export type OrderAllocationItemRow = {
  item_key: string;
  line_key: string;
  physical_sku: string;
  qty: number;
...
/* RKN_INVENTORY_AUDIT_V10_6A_START */
...
/* RKN_INVENTORY_AUDIT_V10_6A_HELPER_END */
...
export function ensureInventoryCoreSchema() {
  db.exec(`
...
export function upsertAllocationDraft(
...
export function getRecentInventoryLedger(
  limit = 100
): InventoryLedgerRow[] {
  ensureInventoryCoreSchema();
...
export function getInventoryCoreStats() {
  ensureInventoryCoreSchema();
...
/* RKN_INVENTORY_AUDIT_V10_6A_END */

/* RKN_INVENTORY_CORE_V10_0_END */